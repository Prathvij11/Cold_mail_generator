...
class Llm:
    ...
    def write_mail(self, job, links):
        prompt_email = PromptTemplate.from_template(
            ...
            ### INSTRUCTION:
            You are Prathvij, a business development executive at AtliQ. AtliQ is an AI & Software Consulting company dedicated to 
            ...
            Remember you are Prathvij, BDE at AtliQ. 
